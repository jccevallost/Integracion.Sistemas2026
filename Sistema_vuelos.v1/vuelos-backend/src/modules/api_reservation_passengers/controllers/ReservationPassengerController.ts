// presentation/controllers/ReservationPassengerController.ts
import { Request, Response, NextFunction } from 'express';
import { IReservationPassengerService } from '../interfaces/IReservationPassengerService.js';

export class ReservationPassengerController {
  constructor(private readonly service: IReservationPassengerService) {}
