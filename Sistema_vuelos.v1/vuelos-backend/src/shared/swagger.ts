    ...
    components: {
      ...
      schemas: {
        ...
        BoardingPass: {
          ...
          properties: {
            id:                      { type: 'string', format: 'uuid' },
            reservationPassengerId:  { type: 'string', format: 'uuid' },
            seatNumber:              { type: 'string', nullable: true, example: '12A' },
            checkInStatus:           { type: 'string', enum: ['NOT_CHECKED_IN','CHECKED_IN','BOARDED','NO_SHOW'] },
        ...
        PassengerService: {
          ...
          properties: {
            ...
            totalPrice:             { type: 'number', example: 25.00 },
            notes:                  { type: 'string', nullable: true },
            serviceCatalog:         { $ref: '#/components/schemas/ServiceCatalog' },
          },
        },
        Invoice: {
          type: 'object',
